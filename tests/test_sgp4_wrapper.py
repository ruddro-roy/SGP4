...
class TestSGP4Wrapper(unittest.TestCase):
    ...
    def test_propagation_accuracy(self):
        ...
        self.assertLess(pos_diff.item(), 0.01, "Position should match within 10 meters")
...
class TestTLEParser(unittest.TestCase):
    ...
    def test_tle_parsing(self):
        ...
        self.assertAlmostEqual(tle_data['mean_motion_rev_per_day'], 15.49541986, places=8)
    ...
    def test_bstar_modification(self):
        ...
        self.assertAlmostEqual(tle_data_new['bstar_drag'], original_bstar * 1.5, places=6)
