...
def demonstrate_tle_parsing(parser: TLEParser, line1: str, line2: str, name: str) -> Dict[str, Any]:
    """
...
def analyze_bstar_sensitivity(
    ...
    for variation in variations:
        ...
        for t in time_points:
            ...
            if error == 0:
                ...
                altitudes.append(0)
                logger.warning(f"SGP4 error {error} at t={t:.1f}min for B*{variation:+d}%")
    ...
    visualize_sensitivity_analysis(
        trajectories, divergences, altitude_data, 
        nominal_altitudes, time_points, variations
    )
...
def visualize_sensitivity_analysis(
    ...
    if divergences:
        ...
        bars = ax2.bar(vars_list, divs_list, color='skyblue', alpha=0.7, edgecolor='navy')
...
def main() -> None:
    ...
    parser.add_argument(
        '--sensitivity',
        action='store_true',
        help='Run B* drag sensitivity analysis'
    )
    parser.add_argument(
        '--verbose',
        action='store_true',
